...
public class BitmapUtils {
    ...
    public static Bitmap res2Bitmap(int resId, int reqWidth, int reqheight) {
        ...
        BitmapFactory.decodeResource(MyApplication.app.getResources(), resId, options);
        options.inPreferredConfig = Bitmap.Config.ARGB_4444;
        options.inSampleSize = calculateInSampleSize(options, reqWidth, reqheight);
        options.inJustDecodeBounds = false;
        return BitmapFactory.decodeResource(MyApplication.app.getResources(), resId, options);
    }
